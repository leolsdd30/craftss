        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-shadow duration-200">
                <div class="flex items-center justify-between">
                    ...
                    <div class="bg-yellow-100 dark:bg-yellow-900/30 rounded-full p-3">
                        <svg class="h-6 w-6 text-yellow-500 dark:text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                        <div class="bg-indigo-500 dark:bg-indigo-400 h-2 rounded-full transition-all duration-300" style="width: <?= $verifyRate ?>%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            <?php
                $roleColors = [
                    ...
                    'craftsman' => 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300',
                    'homeowner' => 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300',
                ];
