...
<!-- Hero Banner -->
<div class="bg-gray-50 dark:bg-gray-900 pt-10 transition-colors">
...
<?php if (!empty($stats)): ?>
<div class="bg-gray-50 dark:bg-gray-900 pt-10 pb-6 transition-colors">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sm:p-10">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left divide-y md:divide-y-0 md:divide-x divide-gray-100 dark:divide-gray-700">

                <!-- Stat 1: Craftsmen -->
                <div class="flex items-center justify-center md:justify-center gap-4 py-4 md:py-0">
                    <div class="p-3 bg-indigo-50 dark:bg-gray-700 text-indigo-600 dark:text-indigo-400 rounded-xl hidden sm:block transition-colors">
