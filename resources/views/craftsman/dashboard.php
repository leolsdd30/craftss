...
html.dark .review-avatar { border-color: #4b5563; }
...
html.dark #confirm-modal .bg-orange-100 { background: #92400e !important; }
html.dark #counter-modal .bg-orange-100 { background: #92400e !important; }
...
html.dark .act-dot.red { background: #7f1d1d; color: #f87171; }
...
html.dark .metric-icon.purple { background: #4c1d95; color: #c084fc; }

/* Metric sub text */
html.dark .metric-sub.green { color: #6ee7b7; }
html.dark .metric-sub.indigo { color: #a5b4fc; }
html.dark .metric-sub.amber { color: #fde68a; }
html.dark .metric-sub.purple { color: #d8b4fe; }

/* Star distribution */
html.dark .star-lbl { color: #d1d5db; }
html.dark .star-bar { background: #4b5563; }
html.dark .star-cnt { color: #d1d5db; }
...
html.dark #counter-modal .bg-white { background: #1f2937 !important; }
html.dark #confirm-modal .text-gray-900,
html.dark #counter-modal .text-gray-900,
html.dark #confirm-modal .text-base,
html.dark #counter-modal .text-base { color: #f3f4f6 !important; }
html.dark #confirm-modal .text-gray-500,
html.dark #counter-modal .text-gray-500,
html.dark #confirm-modal .text-gray-700,
html.dark #counter-modal .text-gray-700 { color: #d1d5db !important; }
html.dark #confirm-modal .text-gray-400,
html.dark #counter-modal .text-gray-400 { color: #9ca3af !important; }
html.dark #confirm-modal .bg-green-100,
html.dark #counter-modal .bg-green-100 { background: #15803d !important; }
html.dark #confirm-modal .bg-red-100,
html.dark #counter-modal .bg-red-100 { background: #b91c1c !important; }
html.dark #confirm-modal .bg-orange-100,
html.dark #counter-modal .bg-orange-100 { background: #b45309 !important; }
html.dark #confirm-modal .text-green-600,
html.dark #counter-modal .text-green-600 { color: #ffffff !important; }
html.dark #confirm-modal .text-red-600,
html.dark #counter-modal .text-red-600 { color: #ffffff !important; }
html.dark #confirm-modal .text-orange-600,
html.dark #counter-modal .text-orange-600 { color: #ffffff !important; }
html.dark #counter-modal input,
html.dark #counter-modal textarea { background: #374151 !important; border-color: #4b5563 !important; color: #f3f4f6 !important; }
html.dark #counter-modal label { color: #d1d5db !important; }
