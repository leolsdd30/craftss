...
?>
<div class="bg-gray-50 dark:bg-gray-900 min-h-screen pb-16 pt-6 sm:pt-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 bg-emerald-50 dark:bg-emerald-900/30 border border-emerald-200 dark:border-emerald-700 text-emerald-800 dark:text-emerald-200 px-6 py-4 rounded-2xl shadow-sm flex items-start gap-4 animate-fade-in-down">
        ...
        <!-- ============================================================ -->
        <div class="bg-white dark:bg-gray-800 rounded-[2rem] shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden mb-8 relative">
            ...
            <div class="px-4 sm:px-10 pb-6 sm:pb-8 pt-2">
                ...
                <div class="sm:hidden relative z-10">
                    ...
                    <div class="flex items-start justify-between -mt-12">
                        <div class="relative w-24 h-24 rounded-2xl ring-4 ring-white dark:ring-gray-800 shadow-lg overflow-hidden bg-white dark:bg-gray-700 shrink-0">
                        ...
                        <div class="flex items-center gap-2 mt-3">
                            ...
                            <div class="relative" id="shareWrapperMobile">
                                <button type="button" onclick="toggleShareMenu()"
                                    class="flex items-center justify-center w-10 h-10 rounded-xl border shadow-sm bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-600 transition-all"
                                    title="Share">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="mt-1.5 flex flex-wrap items-center gap-2.5">
                            ...
                            <span class="text-xs font-medium text-gray-400 dark:text-gray-500">@<?= htmlspecialchars($user['username']) ?></span>
                            <?php endif; ?>
                ...
                <div class="hidden sm:flex sm:flex-row sm:items-end justify-between relative z-10 gap-6">
                    ...
                    <div class="flex flex-row items-end gap-5">
                        <div class="relative w-40 h-40 rounded-3xl ring-[6px] ring-white dark:ring-gray-800 shadow-lg overflow-hidden bg-white dark:bg-gray-700 shrink-0 -mt-24">
                            <img src="<?= get_profile_picture_url($user['profile_picture'] ?? 'default.png', $user['first_name'], $user['last_name']) ?>"
                                 alt="<?= htmlspecialchars($user['first_name']) ?>"
                                 class="object-cover w-full h-full">
                        </div>
                        ...
                        <div class="text-left pb-3">
                            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight flex items-center gap-2.5">
                                <?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?>
                                <?php if ($isCraftsman && !empty($craftsmanDetails['is_verified'])): ?>
                            ...
                            <div class="mt-3 flex flex-wrap items-center gap-3">
                                <?php if (!empty($user['username'])): ?>
                                <span class="text-sm font-medium text-gray-400 dark:text-gray-500">@<?= htmlspecialchars($user['username']) ?></span>
                                <?php endif; ?>
                        ...
                        <div class="relative" id="shareWrapper">
                            ...
                            <div id="shareDropdown" class="hidden absolute right-0 top-full mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 z-50 overflow-hidden">
                                <div class="px-3.5 py-2.5 border-b border-gray-100 dark:border-gray-700">
                                    <p class="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Share Profile</p>
                                </div>
                                <button onclick="copyProfileLink()" class="w-full flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-200 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                                ...
                                <a href="https://wa.me/?text=<?= urlencode('Check out this craftsman on Crafts: ' . APP_URL . '/profile/' . ($user['username'] ?? '')) ?>" target="_blank" rel="noopener" class="flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-200 hover:bg-green-50 dark:hover:bg-green-900/30 hover:text-green-600 dark:hover:text-green-400 transition-colors">
                                ...
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?= urlencode(APP_URL . '/profile/' . ($user['username'] ?? '')) ?>" target="_blank" rel="noopener" class="flex items-center gap-3 px-3.5 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                ...
                <!-- Quick Stats Grid -->
                <?php if ($isCraftsman): ?>
                <div class="grid grid-cols-2 md:grid-cols-<?= !empty($showTotalJobs) ? '4' : '3' ?> gap-3 sm:gap-4 mt-8 pt-8 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div class="bg-yellow-50/40 dark:bg-yellow-900/20 border border-yellow-100/50 dark:border-yellow-800/30 rounded-xl p-4 shadow-sm transition-all flex flex-col justify-center">
                        ...
                        <div class="flex items-end gap-1.5 mt-0.5">
                            ...
                            <span class="text-[11px] font-medium text-gray-500 dark:text-gray-400 mb-[1px]">/ 5.0 (<?= $rating['total_reviews'] ?>)</span>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 relative">
            ...
            <div class="lg:col-span-2 space-y-6 flex flex-col min-w-0">
                ...
                <div class="flex items-start space-x-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30 text-red-700 dark:text-red-400 px-5 py-4 rounded-xl text-sm shadow-md">
                    <svg class="h-5 w-5 flex-shrink-0 mt-0.5 text-red-500 dark:text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="flex items-start space-x-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800/30 text-blue-800 dark:text-blue-300 px-5 py-4 rounded-xl text-sm shadow-md">
                    <svg class="h-5 w-5 flex-shrink-0 mt-0.5 text-blue-500 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-[1.5rem] shadow-sm border border-gray-100 dark:border-gray-700 p-7">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                        ...
                        ?>
                        <div class="relative rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700 cursor-pointer group shadow-sm hover:shadow-lg transition-all duration-300 <?= $index === 0 ? 'col-span-2 row-span-2 aspect-[4/3] sm:aspect-auto' : 'aspect-square' ?>"
                    ...
                    <?php else: ?>
                    <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700 p-10 text-center">
            ...
            <div class="lg:col-span-1">
                <div class="sticky top-24 pt-2">
                    ...
                    <div class="space-y-4 max-h-[800px] overflow-y-auto pr-2 custom-scrollbar pb-6 relative">
                        ...
                        <div class="bg-white dark:bg-gray-800 rounded-[1.25rem] shadow-sm border border-gray-100/60 dark:border-gray-700 p-5 relative overflow-hidden transition-all hover:shadow-md hover:border-indigo-100 dark:hover:border-indigo-900/50">
                            <!-- Decorative background quote -->
                            <div class="absolute -right-2 -top-4 text-gray-50/80 dark:text-gray-700/30 pointer-events-none select-none" style="font-size: 8rem; font-family: serif; line-height: 1;">&rdquo;</div>
                            ...
                            <div class="flex items-start space-x-3.5 relative z-10">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-center justify-between flex-wrap gap-2 mb-0.5">
                                        <p class="text-[15px] font-bold text-gray-900 dark:text-white"><?= htmlspecialchars($review['first_name'] . ' ' . $review['last_name']) ?></p>
                                        <div class="flex items-center gap-0.5">
                                            <?php for ($i = 1; $i <= 5; $i++): ?>
                                            <svg class="h-3.5 w-3.5 <?= $i <= $review['star_rating'] ? 'text-yellow-400' : 'text-gray-200 dark:text-gray-600' ?>" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <?php else: ?>
                    <div class="bg-white dark:bg-gray-800 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 p-8 text-center shadow-sm">
...
<div id="portfolio-lightbox" class="fixed inset-0 z-50 hidden">
    <div class="fixed inset-0 bg-black/90 dark:bg-black/95" onclick="closeLightbox()"></div>
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <button onclick="closeLightbox()" class="absolute top-4 right-4 z-10 text-white/70 hover:text-white transition p-2 bg-black/20 hover:bg-black/40 rounded-full">
...
<div id="launchModal" class="hidden fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-gray-100 dark:border-gray-700">
            ...
            <div class="bg-white dark:bg-gray-800 px-6 pt-2 pb-6">
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-md rounded-xl flex flex-col border border-gray-100 dark:border-gray-700 mx-auto w-full">
                    <div class="p-6 flex-grow relative overflow-hidden">
                        ...
                        <div class="flex items-center space-x-4 mb-4 mt-2">
                            <div class="relative">
                                <img class="h-16 w-16 rounded-full object-cover border-2 border-gray-200 dark:border-gray-600 shadow-sm" 
                                     src="<?= get_profile_picture_url($user['profile_picture'] ?? 'default.png', $user['first_name'], $user['last_name']) ?>" 
                                     alt="<?= htmlspecialchars($user['first_name']) ?>">
                            </div>
                            <div>
                                <h2 class="text-lg font-bold text-gray-900 dark:text-white tracking-tight flex items-center gap-1">
                                    <?= htmlspecialchars($user['first_name'] . ' ' . $user['last_name']) ?>
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400 line-clamp-3 mb-4 leading-relaxed break-words">
