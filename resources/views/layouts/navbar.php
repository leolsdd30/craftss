    ...
    <nav class="bg-white dark:bg-gray-800 shadow dark:shadow-gray-900/50 sticky top-0 z-40 transition-colors duration-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative flex items-center h-16">
                ...
                <button id="mob-menu-btn" class="flex sm:hidden me-3 text-gray-600 dark:text-gray-300" onclick="openDrawer()" aria-label="Open menu">
                ...
                <div class="hidden sm:flex items-center space-x-1 rtl:space-x-reverse ms-10">

                    <a href="<?= APP_URL ?>/" class="nav-pill <?= $isHome ? 'nav-pill-active' : 'nav-pill-inactive' ?>"><?= __('navbar.home') ?></a>
                    ...
                    <div class="relative" id="services-dropdown-wrapper">
                        ...
                        <div id="services-dropdown-menu"
                             class="absolute start-0 mt-2 w-[480px] bg-white dark:bg-gray-800 rounded-2xl shadow-xl dark:shadow-gray-900/60 border border-gray-100 dark:border-gray-700 p-4 z-50">
                            <div class="grid grid-cols-5 gap-1">
                                <a href="<?= APP_URL ?>/search?category=Plumbing" class="services-item group">
                                    ...
                                    <span class="services-label text-blue-700"><?= __('categories.Plumbing') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=Electrical" class="services-item group">
                                    ...
                                    <span class="services-label text-yellow-700"><?= __('categories.Electrical') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=Carpentry" class="services-item group">
                                    ...
                                    <span class="services-label text-orange-700"><?= __('categories.Carpentry') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=Painting" class="services-item group">
                                    ...
                                    <span class="services-label text-pink-700"><?= __('categories.Painting') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=Roofing" class="services-item group">
                                    ...
                                    <span class="services-label text-stone-700"><?= __('categories.Roofing') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=HVAC" class="services-item group">
                                    ...
                                    <span class="services-label text-cyan-700"><?= __('categories.HVAC') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=Landscaping" class="services-item group">
                                    ...
                                    <span class="services-label text-green-700"><?= __('categories.Landscaping') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=Tiling" class="services-item group">
                                    ...
                                    <span class="services-label text-purple-700"><?= __('categories.Tiling') ?></span>
                                </a>
                                <a href="<?= APP_URL ?>/search?category=General+Handyman" class="services-item group">
                                    ...
                                    <span class="services-label text-indigo-700"><?= __('categories.General Handyman') ?></span>
                                </a>
                            </div>
                            <div class="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700 flex justify-center">
                                <a href="<?= APP_URL ?>/search" class="text-xs font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors">
                                    <?= __('home.dir_view_all') ?> &rarr;
                                </a>
                            </div>
                        </div>
                    </div>

                    <a href="<?= APP_URL ?>/jobs" class="nav-pill <?= $isJobs ? 'nav-pill-active' : 'nav-pill-inactive' ?>"><?= __('navbar.job_board') ?></a>
                </div>
                ...
                <div class="ms-auto flex items-center gap-1">
                    ...
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <?php else: ?>
                        <a href="<?= APP_URL ?>/admin/dashboard" class="hidden sm:inline-flex nav-pill flex items-center gap-1 <?= $isDashboard ? 'bg-red-50 text-red-600 dark:bg-red-900/30 dark:text-red-400 font-semibold' : 'text-red-500 dark:text-red-400 hover:bg-red-50 hover:text-red-700 dark:hover:bg-gray-700 dark:hover:text-red-300' ?>">
                        ...
                        <!-- Dark Mode Toggle -->
                        <button onclick="toggleDarkMode()" class="hidden sm:flex items-center justify-center relative p-2 transition-colors duration-200 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-gray-700 dark:hover:text-indigo-400" title="Toggle Dark Mode" id="dark-mode-toggle">
                        ...
                        <a href="<?= APP_URL ?>/messages" class="<?= $baseIconClass . ' ' . ($isMessages ? $activeIconClass : $inactiveIconClass) ?>" title="Messages">
                            ...
                            <span id="nav-unread-badge" class="<?= $headerTotalBadge > 0 ? '' : 'hidden ' ?>absolute -top-0.5 -end-0.5 inline-flex items-center justify-center px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-red-500 text-white min-w-[18px] leading-none ring-2 ring-white dark:ring-gray-800">
                        ...
                        <div class="relative" id="notif-dropdown-wrapper">
                            <button id="notif-dropdown-btn" onclick="toggleNotifDropdown()" class="<?= $baseIconClass . ' ' . ($isNotifs ? $activeIconClass : $inactiveIconClass) ?>" title="Notifications">
                                ...
                                <span id="nav-notif-badge" class="<?= $headerNotifCount > 0 ? '' : 'hidden ' ?>absolute -top-0.5 -end-0.5 inline-flex items-center justify-center px-1.5 py-0.5 rounded-full text-[10px] font-bold bg-red-500 text-white min-w-[18px] leading-none ring-2 ring-white dark:ring-gray-800">
                                    <?= $headerNotifCount > 99 ? '99+' : $headerNotifCount ?>
                                </span>
                            </button>
                            
                            <!-- Dropdown panel -->
                            <div id="notif-dropdown-menu" class="hidden fixed start-2 end-2 top-[68px] sm:absolute sm:start-auto sm:top-auto sm:end-0 sm:mt-2 sm:w-96 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-2xl shadow-2xl dark:shadow-gray-900/60 border border-gray-100/50 dark:border-gray-700/50 py-1 z-[100] origin-top sm:origin-top-right rtl:sm:origin-top-left overflow-hidden" style="animation: dropdownIn 0.15s ease-out;">
                                <div class="px-4 py-3 border-b border-gray-100/50 dark:border-gray-700/50 flex justify-between items-center bg-gray-50/30 dark:bg-gray-700/30">
                                    <h3 class="font-bold text-gray-900 dark:text-gray-100"><?= __('navbar.notifications') ?></h3>
                                    <?php if ($headerNotifCount > 0): ?>
                                    <form method="POST" action="<?= APP_URL ?>/notifications/mark-all-read" class="m-0 p-0 inline">
                                        <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                                        <button type="submit" class="text-xs font-semibold text-indigo-600 hover:text-indigo-800 transition-colors whitespace-nowrap"><?= __('navbar.mark_all_read') ?></button>
                                    </form>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div id="notif-dropdown-list" class="max-h-[350px] overflow-y-auto w-full">
                                    ...
                                    <div class="p-8 flex flex-col items-center justify-center text-gray-400">
                                        ...
                                        <span class="text-sm"><?= __('navbar.fetching') ?></span>
                                    </div>
                                </div>
                                
                                <div class="border-t border-gray-100/50 dark:border-gray-700/50 p-1.5 bg-gray-50/50 dark:bg-gray-700/50 backdrop-blur-md">
                                    <a href="<?= APP_URL ?>/notifications" class="text-xs font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors uppercase tracking-wider block w-full py-2 text-center rounded-xl hover:bg-white dark:hover:bg-gray-700"><?= __('navbar.view_all_activity') ?></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="relative" id="profile-dropdown-wrapper">
                            <button id="profile-dropdown-btn" onclick="toggleProfileDropdown()"
                                ...
                                <span class="hidden sm:inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium <?= $_SESSION['role'] === 'craftsman' ? 'bg-indigo-100 text-indigo-800 dark:bg-indigo-900/40 dark:text-indigo-300' : ($_SESSION['role'] === 'admin' ? 'bg-red-100 text-red-800 dark:bg-red-900/40 dark:text-red-300' : 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300') ?> capitalize">
                                    <?= __('auth.' . $_SESSION['role']) ?? htmlspecialchars($_SESSION['role']) ?>
                                </span>
                            ...
                            <div id="profile-dropdown-menu"
                                 class="hidden absolute end-0 mt-2 w-60 bg-white dark:bg-gray-800 rounded-xl shadow-lg dark:shadow-gray-900/60 border border-gray-100 dark:border-gray-700 py-1.5 z-50 origin-top-right rtl:origin-top-left"
                                ...
                                <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="min-w-0">
                                            ...
                                            <p class="text-xs text-gray-400 dark:text-gray-500 truncate capitalize"><?= __('auth.' . $_SESSION['role']) ?? htmlspecialchars($_SESSION['role']) ?></p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Section 1: Common -->
                                ...
                                <div class="py-1.5">
                                    <form method="POST" action="<?= APP_URL ?>/logout">
                                        <input type="hidden" name="csrf_token" value="<?= $_SESSION['csrf_token'] ?>">
                                        <button type="submit" class="dropdown-item w-full text-start text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-700 dark:hover:text-red-300">
                    ...
                    <?php else: ?>
                        ...
                        <button onclick="toggleDarkMode()" class="hidden sm:flex items-center justify-center relative p-2 transition-colors duration-200 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-gray-700 dark:hover:text-indigo-400" title="Toggle Dark Mode" id="guest-dark-mode-toggle">
                            <!-- Sun icon -->
                            <svg class="h-5 w-5 block dark:hidden text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z" />
                            </svg>
                        ...
                        <a href="<?= APP_URL ?>/login" class="hidden sm:inline-flex nav-pill nav-pill-inactive"><?= __('navbar.login') ?></a>
                        <a href="<?= APP_URL ?>/register" class="hidden sm:inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors duration-200"><?= __('navbar.signup') ?></a>
