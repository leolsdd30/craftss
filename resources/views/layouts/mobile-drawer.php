...
?>
    ...
    <div id="mob-drawer" role="dialog" aria-modal="true" aria-label="Navigation menu">
        ...
        <div class="mob-header">
            <button onclick="closeDrawer()" class="p-2 -ms-1 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-700 dark:hover:text-gray-200 transition flex-shrink-0" aria-label="Close menu">
        ...
        <a href="<?= APP_URL ?>/lang/<?= __('lang') === 'en' ? 'ar' : 'en' ?>" class="mob-link w-full text-start" onclick="closeDrawerFast()">
        ...
        <!-- ── Dark mode toggle ──────────────────────────────── -->
        <div class="mob-divider"></div>
        <button type="button" onclick="event.preventDefault(); toggleDarkMode();" class="mob-link w-full text-start">
            <!-- Sun icon (light mode) -->
            ...
            <div class="ms-auto relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none bg-gray-200 dark:bg-indigo-600 shadow-inner">
                <span class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out rtl:-translate-x-5 translate-x-0 dark:translate-x-5 dark:rtl:-translate-x-0"></span>
            </div>
        </button>
        ...
        <div class="mob-footer">
            ...
            <form method="POST" action="<?= APP_URL ?>/logout">
                ...
                <button type="submit" class="mob-link w-full text-start" style="color:#dc2626;">
