        ...
        <footer class="bg-white border-t border-gray-200 mt-auto py-6">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-500 gap-4">
                ...
                <div class="flex space-x-6">
                    <a href="<?= APP_URL ?>/" class="hover:text-gray-900 transition">Home</a>
                    <a href="<?= APP_URL ?>/search" class="hover:text-gray-900 transition">Search</a>
                    <a href="<?= APP_URL ?>/jobs" class="hover:text-gray-900 transition">Jobs</a>
                </div>
            </div>
        </footer>
        <?php else: ?>
