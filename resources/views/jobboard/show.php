...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 p-4 mb-6 flex items-center gap-3">
            <svg class="h-5 w-5 text-green-500 dark:text-green-400 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg>
        ...
        <div class="rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 p-4 mb-6 flex items-center gap-3">
            ...
            <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sm:p-8">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
                        ...
                        <div class="relative rounded-xl overflow-hidden bg-gray-100 dark:bg-gray-700 cursor-pointer group shadow-sm hover:shadow-lg transition-all duration-300 <?= $index === 0 ? 'col-span-2 row-span-2 aspect-[4/3] sm:aspect-auto' : 'aspect-square min-h-[120px]' ?>"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 sm:p-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="rounded-xl border <?= $quote['status'] === 'accepted' ? 'border-green-200 dark:border-green-800/50 bg-green-50 dark:bg-green-900/20' : ($quote['status'] === 'rejected' ? 'border-gray-100 dark:border-gray-700/50 bg-gray-50 dark:bg-gray-800/50 opacity-60' : 'border-gray-200 dark:border-gray-700/70 bg-white dark:bg-gray-800') ?> p-5 transition-colors">
                                    ...
                                    <div class="min-w-0">
                                        <div class="flex items-center gap-1.5">
                                            <a href="<?= APP_URL ?>/profile/<?= htmlspecialchars($quote['username']) ?>"
                                               class="text-sm font-bold text-gray-900 dark:text-gray-100 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors truncate">
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5"><?= date('M d, Y', strtotime($quote['created_at'])) ?></p>
                                    </div>
                                </div>
                            ...
                            <div class="mt-3 bg-white dark:bg-gray-900/50 rounded-lg border border-gray-100 dark:border-gray-700/50 p-3">
                                <p class="text-sm text-gray-600 dark:text-gray-400 italic leading-relaxed">"<?= htmlspecialchars($quote['cover_message']) ?>"</p>
                            </div>
                            <?php endif; ?>
                ...
                <?php if ($isCraftsman && $alreadyQuoted): ?>
                    ...
                    <!-- Rejected -->
                    <div class="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 flex items-start gap-4">
                        <div class="h-10 w-10 bg-gray-100 dark:bg-gray-900 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <!-- Accepted -->
                    <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800/50 rounded-2xl p-6 flex items-start gap-4">
                        <div class="h-10 w-10 bg-green-100 dark:bg-green-900/40 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div class="w-full lg:w-80 flex-shrink-0 lg:sticky lg:top-24 space-y-4">
                ...
                <div class="space-y-3">
                    <a href="<?= APP_URL ?>/homeowner/dashboard#jobs"
                       class="w-full inline-flex items-center justify-center px-4 py-3 border border-gray-200 dark:border-gray-700 text-sm font-semibold rounded-xl text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150 shadow-sm">
...
<div id="quote-modal" class="fixed inset-0 z-50" style="display:none;">
    <div class="fixed inset-0 bg-gray-900/60 dark:bg-gray-900/80" onclick="closeQuoteModal()"></div>
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-lg">
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-gray-100 dark:border-gray-700">
                <div class="flex items-center gap-3">
                    <div class="h-9 w-9 bg-indigo-100 dark:bg-indigo-900/40 rounded-xl flex items-center justify-center">
                ...
                <button onclick="closeQuoteModal()" class="text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
...
<div id="acceptModal" class="fixed inset-0 z-50" style="display:none;">
    <div class="fixed inset-0 bg-gray-900/60 dark:bg-gray-900/80" onclick="closeAcceptModal()"></div>
    <div class="fixed inset-0 flex items-center justify-center p-4">
...
<div id="rejectModal" class="fixed inset-0 z-50" style="display:none;">
    <div class="fixed inset-0 bg-gray-900/60 dark:bg-gray-900/80" onclick="closeRejectModal()"></div>
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
            <div class="flex items-center mb-4">
...
<div id="deleteModal" class="fixed inset-0 z-50" style="display:none;">
    <div class="fixed inset-0 bg-gray-900/60 dark:bg-gray-900/80" onclick="closeDeleteModal()"></div>
    <div class="fixed inset-0 flex items-center justify-center p-4">
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-md w-full p-6">
            <div class="flex items-center mb-4">
                <div class="h-10 w-10 rounded-full bg-red-100 dark:bg-red-900/40 flex items-center justify-center mr-3">
