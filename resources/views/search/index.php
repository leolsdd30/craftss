                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5 mb-5">
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center gap-3 px-3 py-2 rounded-lg cursor-pointer transition-colors
                                      <?= $isActive ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300' : 'hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300' ?>">
        ...
        <div class="flex-1 min-w-0">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 relative z-30">
                ...
                <div class="relative" id="wilaya-wrapper">
                    ...
                    <?php endif; ?>
                    <div id="wilaya-dropdown" class="hidden absolute left-0 right-0 top-full mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl dark:shadow-gray-900/50 max-h-64 overflow-y-auto z-50"></div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col overflow-hidden relative group">
                    ...
                    <div class="p-6 flex-grow flex flex-col">
                        ...
                        <div class="flex items-start gap-3.5 mb-4">
                            <div class="relative flex-shrink-0">
                                <img class="h-14 w-14 rounded-full object-cover ring-2 shadow-sm <?= $catStyles['ring'] ?? 'ring-gray-100 dark:ring-gray-700' ?>"
                            ...
                            <div class="min-w-0 flex-1 pt-0.5">
                                <h2 class="text-sm font-bold text-gray-900 dark:text-gray-100 leading-tight truncate flex items-center gap-1">
                                    <?= htmlspecialchars($craft['first_name'] . ' ' . $craft['last_name']) ?>
                                    <?php if ($craft['is_verified']): ?>
                                    <svg class="h-4 w-4 text-blue-500 dark:text-blue-400 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor" title="Verified">
                        ...
                        <div class="flex items-center gap-1.5 mb-3">
                            ...
                            <?php if ($total > 0): ?>
                                ...
                                <span class="text-xs font-bold text-gray-700 dark:text-gray-300"><?= $avg ?></span>
            ...
            <div class="mt-10 flex justify-center">
                <nav class="relative z-0 inline-flex rounded-xl shadow-sm -space-x-px" aria-label="Pagination">
                    ...
                    ?>
                    <?php if ($page > 1): ?>
                    <a href="<?= $buildUrl($page - 1) ?>" class="relative inline-flex items-center px-3 py-2 rounded-l-xl rtl:rounded-l-none rtl:rounded-r-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <svg class="h-4 w-4 <?= __('lang') === 'ar' ? 'rotate-180' : '' ?>" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                    </a>
                    <?php else: ?>
                    <span class="relative inline-flex items-center px-3 py-2 rounded-l-xl rtl:rounded-l-none rtl:rounded-r-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm text-gray-300 dark:text-gray-500 cursor-not-allowed">
                        <svg class="h-4 w-4 <?= __('lang') === 'ar' ? 'rotate-180' : '' ?>" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                    </span>
                    <?php endif; ?>
                    ...
                    <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                        ...
                        <?php else: ?>
                        <a href="<?= $buildUrl($i) ?>" class="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 relative inline-flex items-center px-4 py-2 border text-sm font-medium"><?= $i ?></a>
                        <?php endif; ?>
                    <?php endfor; ?>

                    <?php if ($page < $totalPages): ?>
                    <a href="<?= $buildUrl($page + 1) ?>" class="relative inline-flex items-center px-3 py-2 rounded-r-xl rtl:rounded-r-none rtl:rounded-l-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700">
                        <svg class="h-4 w-4 <?= __('lang') === 'ar' ? 'rotate-180' : '' ?>" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/></svg>
                    </a>
                    <?php else: ?>
                    <span class="relative inline-flex items-center px-3 py-2 rounded-r-xl rtl:rounded-r-none rtl:rounded-l-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-sm text-gray-300 dark:text-gray-500 cursor-not-allowed">
                        <svg class="h-4 w-4 <?= __('lang') === 'ar' ? 'rotate-180' : '' ?>" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/></svg>
                    </span>
                    <?php endif; ?>
                </nav>
...
<div id="filter-drawer" class="fixed inset-x-0 bottom-0 z-50 bg-white dark:bg-gray-800 rounded-t-2xl shadow-2xl dark:shadow-gray-900/60 transform translate-y-full transition-transform duration-300 ease-out lg:hidden" style="max-height:85vh">
