...
pwField.addEventListener('input', function () {
    ...
    if (val.length === 0) {
        ...
        pwField.classList.remove('border-green-400', 'dark:border-green-500', 'border-red-400', 'dark:border-red-500');
...
function checkMatch() {
    ...
    if (val.length === 0) {
        ...
        pwConfirm.classList.remove('border-green-400', 'dark:border-green-500', 'border-red-400', 'dark:border-red-500');
        pwConfirm.classList.add('border-gray-300', 'dark:border-gray-600');
        return;
    }
